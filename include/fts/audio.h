...
FTS_API fts_audioport_t *fts_audioport_get_default( void);
FTS_API fts_audioport_t *fts_audioport_get_default_in( void);
FTS_API fts_audioport_t *fts_audioport_get_default_out( void);
