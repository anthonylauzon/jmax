...
PREDEF_SYMBOL( fts_s_reopen, "reopen")
...
PREDEF_SYMBOL( fts_s_read_write, "read_write")
PREDEF_SYMBOL( fts_s_dump, "dump")
PREDEF_SYMBOL( fts_s_save, "save")
PREDEF_SYMBOL( fts_s_saveas, "saveas")
...
PREDEF_SYMBOL( fts_s_sample_rate, "sample_rate")
PREDEF_SYMBOL( fts_s_midi, "midi")
PREDEF_SYMBOL( fts_s_midi_in, "midi_in")
PREDEF_SYMBOL( fts_s_midi_out, "midi_out")
PREDEF_SYMBOL( fts_s_audio, "audio")
PREDEF_SYMBOL( fts_s_audio_in, "audio_in")
PREDEF_SYMBOL( fts_s_audio_out, "audio_out")
PREDEF_SYMBOL( fts_s_apply, "apply")
...
PREDEF_SYMBOL( fts_s_current_project, "current_project")
