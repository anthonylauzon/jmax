...
PREDEF_SYMBOL( fts_s_append_state_to_array, "append_state_to_array")
PREDEF_SYMBOL( fts_s_set_state_from_array, "set_state_from_array")
PREDEF_SYMBOL( fts_s_timer_tick, "timer_tick")
PREDEF_SYMBOL( fts_s_timer_alarm, "timer_alarm")
PREDEF_SYMBOL( fts_s_timer_locate, "timer_locate")
