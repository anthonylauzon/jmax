...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib jvm.lib /nologo /subsystem:windows /incremental:yes /pdb:"$(OUTDIR)\jmax.pdb" /debug /machine:I386 /out:"..\bin\jmax.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\jmax.obj"
