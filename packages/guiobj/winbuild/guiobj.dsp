...
# ADD CPP /nologo /MT /W3 /GX /O2 /Op /I "..\..\..\include" /I "..\..\data\c\src" /I "..\..\mess\c\src" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "GUIOBJ_EXPORTS" /YX /FD /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib data.lib fts.lib /nologo /dll /machine:I386 /libpath:"..\..\data\c" /libpath:"..\..\..\fts\lib"
