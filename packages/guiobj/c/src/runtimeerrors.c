...
runtime_errors_instantiate(fts_class_t *cl, int ac, const fts_atom_t *at)
{
  ...
  fts_method_define_varargs(cl, fts_SystemInlet, fts_s_init, fts_runtime_errors_init);
  fts_method_define_varargs(cl, fts_SystemInlet, fts_s_delete, fts_runtime_errors_delete);
