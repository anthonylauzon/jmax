...
public class ChangeRangeDialog extends JDialog {
  ...
  public ChangeRangeDialog(TrackBaseEditor editor, Frame frame)
  {
  ...
  public static void changeRange(TrackBaseEditor trackEditor, Frame frame, Point position)
  {
    ChangeRangeDialog dialog = new ChangeRangeDialog(trackEditor, frame);
