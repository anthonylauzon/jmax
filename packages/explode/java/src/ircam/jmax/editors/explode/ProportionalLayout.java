...
public class ProportionalLayout implements LayoutManager {
  ...
  // utility routine. Debug purposes only
  private void debugLocations(Component c)
  {
    System.err.println("component in "+c.getLocation().x+", "+c.getLocation().y+", "+c.getSize().width+", "+c.getSize().height);
  } 
