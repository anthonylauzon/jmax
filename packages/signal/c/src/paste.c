...
{  
  ...
  fts_method_define_varargs(cl, fts_SystemInlet, fts_s_init, paste_init);
  fts_method_define_varargs(cl, fts_SystemInlet, fts_s_delete, paste_delete);      
  
  fts_method_define_varargs(cl, fts_SystemInlet, fts_s_put, paste_put);
