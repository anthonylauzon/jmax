 ...
 */
public class FtsFvecObject extends FtsObjectWithEditor 
{
  static
  {
    FtsObject.registerMessageHandler( FtsFvecObject.class, FtsSymbol.get("editor"), new FtsMessageHandler(){
	public void invoke( FtsObject obj, FtsArgs args)
	{
	  ((FtsFvecObject)obj).setFtsEditor( args.getInt( 0));
	}
      });
  }
   ...
   * constructor.
   */
  public FtsFvecObject(FtsServer server, FtsObject parent, int objId, String classname, FtsAtom args[], int offset, int length)
  {
