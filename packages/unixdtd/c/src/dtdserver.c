...
static void
dtdserver_get_state(fts_daemon_action_t action, fts_object_t* o, fts_symbol_t property, fts_atom_t* value)
{
...
static void dtdserver_instantiate(fts_class_t *cl)
{
  ...
  fts_class_method_varargs(cl, fts_s_sched_ready, dtdserver_select);
