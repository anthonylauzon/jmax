  ...
  public ErrorTablePanel(Fts fts)
  {
    ...
    table.addMouseListener(new MouseListener(){
		...
		if (e.getClickCount() == 2)
			...
			if ((index >= 0) && (index < tableModel.getObjectSet().getSize()))
			    {
				if (objectSelectedListener != null)
				    {
					FtsObject object = (FtsObject) tableModel.getObjectSet().getElementAt(index);
    ...
    tableModel.getObjectSet().addListDataListener(new ListDataListener(){
