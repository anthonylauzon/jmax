...
public class FtsDotPatParser
{
  ...
  static class FtsGraphicDescription
  {
    ...
    final void setTextGraphicProperties(FtsObject obj)
    {
      obj.setX(x);
      obj.setY(y);
      obj.setWidth(width);
    ...
    final void setSliderGraphicProperties(FtsObject obj)
    {
      obj.setX(x);
      obj.setY(y);
      obj.setWidth(width);
    ...
    final void setSquareGraphicProperties(FtsObject obj)
    {
      obj.setX(x);
      obj.setY(y);
      obj.setWidth(width);
