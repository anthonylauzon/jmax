...
class MaxSystemPropertyCmd implements Command
{
  ...
  public void cmdProc(Interp interp, TclObject argv[]) throws TclException
  {
    if (argv.length == 2)
      {
	String property = MaxApplication.ermesProperties.getProperty(argv[1].toString());
	...
	if (property == null) 
      ...
      throw new TclException(interp, "wrong number of argumens: usage: systemProperty property");
  }
}
