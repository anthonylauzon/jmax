...
{ 
    ...
    public SettingsTable makeSettings(ircam.jmax.script.pkg.Package pkg) {
	return null;
    }

    public Object makeWorkSpace(ircam.jmax.script.pkg.Package pkg) { 
	return null;
    }

    public void setContext(ircam.jmax.script.pkg.Package pkg) {}
    public void removeContext(ircam.jmax.script.pkg.Package pkg) {}
}
