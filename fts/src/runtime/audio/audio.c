...
/*----------------------------------------------------------------------------*/
/* A utilitity on hash tables                                                 */
/*----------------------------------------------------------------------------*/
static void h_apply( fts_hash_table_t *table, void (*fun)( fts_atom_t *a))
{
  ...
  while( !fts_hash_table_iterator_end( &iter))
    {
      (*fun)( fts_hash_table_iterator_current_value( &iter) );
...
static void fts_audio_close_an_input_device( fts_atom_t *data)
{
  fts_atom_t a;
...
static void fts_audio_close_an_output_device( fts_atom_t *data)
{
  fts_atom_t a;
...
{
  h_apply( &fts_audio_input_logical_device_table, fts_audio_close_an_input_device);
  h_apply( &fts_audio_output_logical_device_table, fts_audio_close_an_output_device);
}
...
fts_audio_input_logical_device_t *fts_audio_get_input_logical_device(fts_symbol_t name)
{
  ...
  ret = fts_hash_table_get(&fts_audio_input_logical_device_table, name, &data);
  ...
  if (ret)
  ...
  else
    {
      ...
      fts_hash_table_put(&fts_audio_input_logical_device_table, name, &data);
...
fts_audio_output_logical_device_t *fts_audio_get_output_logical_device(fts_symbol_t name)
{
  ...
  ret = fts_hash_table_get(&fts_audio_output_logical_device_table, name, &data);
  ...
  if (ret)
  ...
  else
    {
      ...
      fts_set_ptr(&data, ldev);
      fts_hash_table_put(&fts_audio_output_logical_device_table, name, &data);
...
static void fts_audio_activate_input_logical_device( fts_atom_t *data)
{
  fts_audio_input_logical_device_t *ldev = (fts_audio_input_logical_device_t *) fts_get_ptr(data);
...
static void fts_audio_activate_output_logical_device( fts_atom_t *data)
{
  int i;
  fts_audio_output_logical_device_t *ldev = (fts_audio_output_logical_device_t *) fts_get_ptr(data);
...
{
  h_apply( &fts_audio_input_logical_device_table, fts_audio_activate_input_logical_device);
  h_apply( &fts_audio_output_logical_device_table, fts_audio_activate_output_logical_device);
}

/* call this after stopping  dsp */

static void fts_audio_deactivate_input_logical_device( fts_atom_t *data)
{
  fts_audio_input_logical_device_t *ldev = (fts_audio_input_logical_device_t *) fts_get_ptr(data);
...
static void fts_audio_deactivate_output_logical_device( fts_atom_t *data)
{
  int i;
  fts_audio_output_logical_device_t *ldev = (fts_audio_output_logical_device_t *) fts_get_ptr(data);
...
{
  h_apply( &fts_audio_input_logical_device_table, fts_audio_deactivate_input_logical_device);
  h_apply( &fts_audio_output_logical_device_table, fts_audio_deactivate_output_logical_device);
}
...
static void fts_audio_add_out_zero_fun_uncond( fts_atom_t *data)
{
  fts_audio_output_logical_device_t *ldev = (fts_audio_output_logical_device_t *) fts_get_ptr(data);
...
static void fts_audio_add_in_read_fun_uncond( fts_atom_t *data)
{
  fts_audio_input_logical_device_t *ldev = (fts_audio_input_logical_device_t *) fts_get_ptr(data);
...
{
  h_apply( &fts_audio_input_logical_device_table, fts_audio_add_in_read_fun_uncond);
  h_apply( &fts_audio_output_logical_device_table, fts_audio_add_out_zero_fun_uncond);
}


static void fts_audio_add_zero_fun_unused( fts_atom_t *data)
{
  fts_audio_output_logical_device_t *ldev = (fts_audio_output_logical_device_t *) fts_get_ptr(data);
...
static void fts_audio_add_in_read_fun_unused( fts_atom_t *data)
{
  fts_audio_input_logical_device_t *ldev = (fts_audio_input_logical_device_t *) fts_get_ptr(data);
...
{
  h_apply( &fts_audio_input_logical_device_table, fts_audio_add_in_read_fun_unused);
  h_apply( &fts_audio_output_logical_device_table, fts_audio_add_zero_fun_unused);
}
