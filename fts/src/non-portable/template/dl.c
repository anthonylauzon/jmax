...
/*
 * This file provides a standard interface for dynamic linking, encapsulating
 * platform specific functions.
 * 
 * FTS uses these functions in sys/modules.c
 */

/*
 * This file contains templates for dynamic linking standard interface.
 */
