...
fts_symbol_t fts_s_connect_inlet;
fts_symbol_t fts_s_connect_outlet;
fts_symbol_t fts_s_disconnect_inlet;
fts_symbol_t fts_s_disconnect_outlet;
...
fts_predefine_symbols(void)
{
  ...
  fts_s_connect_inlet     = fts_new_symbol("$connect_inlet");
  fts_s_connect_outlet    = fts_new_symbol("$connect_outlet");
