...
DEFINE_FTS_VECX_FUN(icpy, long, long, FUN_cpy)
...
DEFINE_FTS_VECX_FILL(ifill, long, long, FUN_cpy)
...
DEFINE_FTS_VECX_SET(izero, long, FUN_zero)
DEFINE_FTS_VECX_SET(czero, complex, FUN_czero)

DEFINE_FTS_VECX_FUN(fcasti, float, long, FUN_cpy)
DEFINE_FTS_VECX_FUN(icastf, long, float, FUN_cpy)




DEFINE_FTL_VECX_FUN(fcpy, float, float, FUN_cpy)
DEFINE_FTL_VECX_FUN(icpy, long, long, FUN_cpy)
...
DEFINE_FTL_VECX_FILL(ifill, long, long, FUN_cpy)
...
DEFINE_FTL_VECX_SET(izero, long, FUN_zero)
DEFINE_FTL_VECX_SET(czero, complex, FUN_czero)

DEFINE_FTL_VECX_FUN(fcasti, float, long, FUN_cpy)
DEFINE_FTL_VECX_FUN(icastf, long, float, FUN_cpy)
