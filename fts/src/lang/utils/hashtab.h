...
/*
  Function: fts_hash_table_lookup
  Description:
  ...
  Returns:
    0 if entry is not present, 1 if entry is present
*/
extern int fts_hash_table_lookup( const fts_hash_table_t *table, fts_symbol_t key, fts_atom_t *value);
