...
/*
 * This files currently contains the sound format structures. In
 * future, a generic sound file interface will be defined. External
 * packages will be able to implement the sound file interface by
 * installing callbacks. Until then, two implementations are provided
