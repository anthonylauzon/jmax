...
/*
 * Default implementation of the soundfiles interface. Contains empty
 * functions. This file is a good start to implement the soundfile
 * interface using an available sound file library.
 * */
